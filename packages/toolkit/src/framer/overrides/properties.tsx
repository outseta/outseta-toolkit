...
import { OutsetaLogger, getNestedProperty, user as userActions } from "@outseta/sdk";
import { useUser } from "@outseta/react";
  ...
  return forwardRef((props, ref) => {
    ...
    try {
      ...
      const handleClick = async (event: React.MouseEvent) => {
        ...
        userActions.updateProperty(property, newPropertyValue);
